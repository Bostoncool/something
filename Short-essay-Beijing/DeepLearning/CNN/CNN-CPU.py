...
# ============================== 第6部分: PyTorch数据集和数据加载器 ==============================
print("\n" + "=" * 80)
print("第3步: 创建PyTorch数据集")
print("=" * 80)
...
print("\n模型文件:")
print("  - cnn_optimized.pth           CNN模型（PyTorch格式）")
print("  - model_info.pkl              模型信息")
