...
axes[0].set_title('BPNN Basic Model - Training Process', fontsize=13, fontweight='bold')
...
axes[1].set_title('BPNN Optimized Model - Training Process', fontsize=13, fontweight='bold')
...
axes[0].set_title('BPNN Basic Model - Time Series Prediction Comparison (Last 300 Days of Test Set)', 
...
axes[1].set_title('BPNN Optimized Model - Time Series Prediction Comparison (Last 300 Days of Test Set)', 
                  fontsize=13, fontweight='bold')
axes[1].legend(fontsize=10)
axes[1].grid(True, alpha=0.3)
