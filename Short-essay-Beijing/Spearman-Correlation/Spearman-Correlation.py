...
class BeijingSpearmanAnalyzer:
    ...
    def plot_correlation_heatmap(self, correlation_matrix: pd.DataFrame, 
        ...
        """Plot correlation heatmap with gradient scheme"""
        ...
        # Use gradient color mapping for Spearman correlation
        sns.heatmap(correlation_matrix, 
                   mask=mask,
                   annot=False,  # Don't display numbers
                   cmap='RdYlBu_r',  # Use gradient color mapping
                   center=0,
                   square=True,
...
def main():
    ...
    # Create analyzer
    analyzer = BeijingSpearmanAnalyzer(meteo_data_dir, pollution_data_dir)
