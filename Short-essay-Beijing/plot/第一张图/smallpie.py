...
# 数据准备
categories = ['移动源', '生活源', '工业源', '扬尘源',"其他源"]
values = [50, 18, 10, 10, 12 ]

# 创建柔和的配色方案（Pastel柔和色调）
colors = ['#FFB3BA', '#FFDFBA', '#FFFFBA', '#BAFFC9', '#BAE1FF','#BAE1FE']
...
for i, (wedge, category, value) in enumerate(zip(wedges, categories, values)):
    ...
    ax.text(x, y, label_text, 
            ha='center', va='center', 
            fontsize= 25 , fontweight='bold', #调节字体大小
            color='black',
