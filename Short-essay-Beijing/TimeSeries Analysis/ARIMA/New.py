...
print("=" * 80)
print("Beijing PM2.5 Concentration Prediction - Simplified ARIMA Model")
print("=" * 80)

# ============================== Part 1: Configuration and Path Setup ==============================
print("\nConfiguring parameters...")

# Data path (only PM2.5 data)
pollution_all_path = '/root/autodl-tmp/Benchmark/all(AQI+PM2.5+PM10)'

# Output path
output_dir = Path('./simplified_output')
output_dir.mkdir(exist_ok=True)

# Model save path
model_dir = Path('./simplified_models')
...
# ============================== Part 2: Simplified Data Loading Functions ==============================
...
def read_pollution_day(args):
    ...
    try:
        ...
        # Filter out 24-hour average and AQI, keep only PM2.5
...
def read_all_pollution():
    ...
    with ProcessPoolExecutor(max_workers=MAX_WORKERS) as executor:
        ...
        if TQDM_AVAILABLE:
            for future in tqdm(as_completed(futures), total=len(futures),
                             desc="Loading PM2.5 data", unit="day"):
    ...
    if pollution_series:
        ...
        print(f"PM2.5 data loading complete, shape: {pm25_series.shape}")
        return pm25_series
    return pd.Series()
...
if pm25_series.empty:
    print("\n⚠️ Warning: PM2.5 data is empty! Please check data path and files.")
    import sys
    sys.exit(1)
...
# ============================== Part 4: Stationarity Analysis ==============================
print("\n" + "=" * 80)
print("Step 2: Stationarity Analysis")
print("=" * 80)
...
seasonal_order_basic = (1, 1, 1, 7)  # 使用周季节性
...
def improved_auto_arima_search(y_train):
    ...
    print("\nUsing auto_arima with better parameter ranges...")
...
# 12.2 Time series prediction comparison
...
if basic_model_success:
    ...
    axes[0].set_title('ARIMA Basic Model - Time Series Prediction (Last 200 Days)',
...
axes[1].set_title('ARIMA Optimized Model - Time Series Prediction (Last 200 Days)',
                  fontsize=14, fontweight='bold')
...
print("✓ Simplified data loading - only PM2.5 concentration data")
print("✓ Time series preprocessing with interpolation and outlier handling")
print("✓ Stationarity analysis and ARIMA parameter selection")
print("✓ Model evaluation and residual diagnostics")
...
print("\n" + "=" * 80)
print("SIMPLIFIED ARIMA PM2.5 Concentration Prediction Complete!")
print("=" * 80)
