...
def main():
    ...
    """
    # 设置输入和输出文件夹路径
    input_folder = r"C:\Users\IU\Desktop\Datebase Origin\ERA5-Beijing-NC\high_vegetation_cover"  # 修改为您的NC文件文件夹路径
    output_folder = r"C:\Users\IU\Desktop\Datebase Origin\ERA5-Beijing-CSV\high_vegetation_cover"  # 修改为您想要保存CSV文件的文件夹路径
