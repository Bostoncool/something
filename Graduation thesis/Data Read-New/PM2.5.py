...
DEFAULT_INPUT_DIR = _DATA_ROOT / "2018-2023[PM2.5-china-clusters]"
DEFAULT_OUTPUT_CSV = _DATA_ROOT / "pm25_yearly_summary_2018_2023.csv"
# 兼容年尺度(Y1K)与日尺度(D1K)命名，统一从文件名提取年份。
FILENAME_PATTERN = re.compile(r"(20\d{2})")
