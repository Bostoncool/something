...
def main():
    ...
    # 保存原始PM2.5数据
    output_file1 = r"E:\DATA Science\大论文Result\BTH\daily_pm25_data.csv"
    ...
    if stats_results is not None and not stats_results.empty:
        # 保存统计分析结果
        output_file2 = r"E:\DATA Science\大论文Result\BTH\pm25_statistics.csv"
    ...
    if not pm25_results.empty:
        ...
        # 保存等级分布
        output_file3 = r"E:\DATA Science\大论文Result\BTH\pm25_level_distribution.csv"
