...
# =========================
geojson_files <- c(
  "E:/DATA Science/大论文Result/大论文图/3.长三角/上海市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/南京市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/无锡市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/常州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/苏州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/南通市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/扬州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/镇江市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/泰州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/盐城市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/合肥市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/芜湖市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/马鞍山市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/铜陵市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/安庆市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/池州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/滁州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/宣城市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/杭州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/宁波市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/温州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/嘉兴市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/湖州市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/绍兴市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/金华市.geojson",
  "E:/DATA Science/大论文Result/大论文图/3.长三角/具体城市/舟山市.geojson",
...
normalize_city_name <- function(x) {
  ...
  case_when(
    str_detect(x_norm, "上海") ~ "上海",
    str_detect(x_norm, "南京") ~ "南京",
    str_detect(x_norm, "无锡") ~ "无锡",
    str_detect(x_norm, "常州") ~ "常州",
    str_detect(x_norm, "苏州") ~ "苏州",
    str_detect(x_norm, "南通") ~ "南通",
    str_detect(x_norm, "扬州") ~ "扬州",
    str_detect(x_norm, "镇江") ~ "镇江",
    str_detect(x_norm, "泰州") ~ "泰州",
    str_detect(x_norm, "盐城") ~ "盐城",
    str_detect(x_norm, "合肥") ~ "合肥",
    str_detect(x_norm, "芜湖") ~ "芜湖",
    str_detect(x_norm, "马鞍山") ~ "马鞍山",
    str_detect(x_norm, "铜陵") ~ "铜陵",
    str_detect(x_norm, "安庆") ~ "安庆",
    str_detect(x_norm, "池州") ~ "池州",
    str_detect(x_norm, "滁州") ~ "滁州",
    str_detect(x_norm, "宣城") ~ "宣城",
    str_detect(x_norm, "杭州") ~ "杭州",
    str_detect(x_norm, "宁波") ~ "宁波",
    str_detect(x_norm, "温州") ~ "温州",
    str_detect(x_norm, "嘉兴") ~ "嘉兴",
    str_detect(x_norm, "湖州") ~ "湖州",
    str_detect(x_norm, "绍兴") ~ "绍兴",
    str_detect(x_norm, "金华") ~ "金华",
    str_detect(x_norm, "舟山") ~ "舟山",
    str_detect(x_norm, "台州") ~ "台州",
    TRUE ~ x_norm
  )
}
...
for (yr in years_target) {
  ...
  if (debug_mode && yr == debug_year && mode == "city") {
    ...
    city_stats <- pollution_daily %>%
      mutate(city = normalize_city_name(city)) %>%
      group_by(city) %>%
      summarise(
        n_total = n(),
        n_non_na = sum(!is.na(pm25)),
        pm25_na_rate = mean(is.na(pm25)),
        pm25_mean = mean(pm25, na.rm = TRUE),
        .groups = "drop"
      )

    write_csv(city_stats, file.path(debug_dir, "debug_city_stats_2018.csv"))
  }
  ...
  if (mode == "point") {
    ...
    if (debug_mode && yr == debug_year) {
      write_csv(
        data_join %>% st_drop_geometry() %>% filter(is.na(pm25_mean)),
        file.path(debug_dir, "debug_fill_na_2018.csv")
      )
      write_csv(
        data_join %>% st_drop_geometry(),
        file.path(debug_dir, "debug_join_all_2018.csv")
      )
    }
    p <- p +
      geom_sf(
  ...
  p <- p +
    ...
    labs(
      title = paste0("长三角PM2.5年均浓度分布（", yr, "）"),
      x = "经度 (°E)",
      y = "纬度 (°N)"
    ) +
    coord_sf(
  ...
  out_file <- file.path(output_dir, paste0("长三角_PM2.5_年均_", yr, ".svg"))
  ggsave(
    filename = out_file,
    plot = p,
    device = "svg",
