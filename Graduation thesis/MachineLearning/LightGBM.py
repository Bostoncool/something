...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--num-leaves", type=int, default=63, help="Maximum tree leaves.")
...
def main() -> int:
    ...
    model = train_lightgbm(x_train, y_train, x_valid, y_valid, args)
    ...
    export_regression_artifacts(all_pred_df=all_pred_df, output_dir=output_dir, model_name="LightGBM")
